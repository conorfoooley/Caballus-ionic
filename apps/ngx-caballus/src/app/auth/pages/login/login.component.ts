...
import { AuthService, ToastService, UserService, User, UserDeviceInfo } from '@caballus/ui-common';
...
export class LoginComponent implements OnInit {
    ...
    public tryLogin({
        ...
        valid: boolean;
        value: { email: string; password: string, deviceInfo: UserDeviceInfo };
    }): void {
        if (!valid) {
            return;
        }
        ...
        this._store
            .dispatch(new LoginAction(value.email, value.password, value.deviceInfo))
            .pipe(
