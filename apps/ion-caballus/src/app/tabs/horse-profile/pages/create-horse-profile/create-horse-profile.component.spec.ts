...
import { CreateHorseProfileComponent } from './create-horse-profile.component';
...
describe('CreateHorseProfileComponent', () => {
    let component: CreateHorseProfileComponent;
    let fixture: ComponentFixture<CreateHorseProfileComponent>;
    ...
    const setupHelper = async (): Promise<void> => {
        fixture = TestBed.createComponent(CreateHorseProfileComponent);
    ...
    beforeEach(() => {
        MockHorseCache.getHorsesForList.mockReset();
    });
